...
* **Can you infer the owners of each credit card and loyalty card? What is your evidence?** 
  ...
  + Set CarID = 4 and get the movement path as shown below, and it's obvious that the car was parked at Desafio Golf Course on 12th and 19th of Jan. similar to the above logic, compare the frequently visited spots shown in path and the consumption mode displayed by 2d histograms of credit card, and found the most similar pair of CarID owner and credit card owner, then according to the credit card find the loyalty card with the most similar transaction frequency shown by 2d histogram. Thus the owner of CarID 4 is most likely the owner of credit card 7688 and loyalty card L4164.
    ...
    <p style="text-align:center;"> ![](img/a4.3.4-2.jpg){width=80%}  ![](img/a4.3.4-3.jpg){width=80%} <br> _Fig.24 Tr++ansaction frequency of credit and loyalty card by day_ </p>
  ...
  + Set CarID = 35 and get the movement path as shown below. It's obvious that the car was parked at Desafio Golf Course on 12th and 19th of Jan. According to comparison with following 2d histograms, the owner of CarID 35 is most likely the owner of credit card 2463 and loyalty card L6886.
    ...
    <p style="text-align:center;"> ![](img/a4.3.35-1.jpg){width=100%} ![](img/a4.3.35-1-2.jpg){width=60%} <br>  _Fig.85 The moving path of CarID 34_ </p>
...
* **Given the data sources provided, identify potential informal or unofficial relationships among GASTech personnel. Provide evidence for these relationships.**
  ...
  + Brand Tempestad and Edvard Vann: These two people are the car owner of CarID 33 and 34. Seeing the moving path below, their moving path looks quite similar, and it seems they went to Ahaggo Museum together, the place near Brew've Been Served and Roberts and Sons at the same days.
  ...
  + Stenig Fusil and Edvard Vann: These two people are the car owner of CarID 20 and 34. Seeing the moving path below, they have similar path in the place near Brew've Been Served and Roberts and Sons at the same days. 
  ...
  + Lars Azada, Felix Balas, Gustav Cazar, Axel Calzas and Vira Frente: They are the car owner of CarID 2, 3, 9, 11 and 19. Seeing the figures below, they have quite similar moving path in same days passing by Bean There Done That, Albert's Fine Clothing, Jack's Magic Beans and GASTech. 
  ...
  + Adra Nubarron, Varja Lagos and Felix Resumir: They are the car owner of CarID 22, 23 and 30. Seeing the figures below, they have quite similar moving path in same days passing by the places near Katherina's Cafe, Kronos Mart, Ouzeri Elian, Roberts And Sons, Kronos Mart, Jack's Magic Beans and Albert's Fine Clothing.
...
* **Do you see evidence of suspicious activity? **
  ...
  Below are the places I think may have suspicious activity:
