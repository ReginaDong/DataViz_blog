...
Set *hour* as filtering criteria, and differentiate the line colors by *id*, so that the geographical graph could show the movement track of all cars in specific hour of days.  
