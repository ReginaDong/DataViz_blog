...
* **Can you infer the owners of each credit card and loyalty card? What is your evidence?** 
  ...
  + Set CarID =2 and get the moment path. The favorite place for the owner of CarID 2 are Bean There Done That,Genral Grocer and Albert's Fine Clothing. Thus the owner of credit card 6895 and loyalty card L3366 is most like the owner of CarID2, as shown in 2d histograms below.
  ...
  + Set CarID = 3 and and get the moment path as shown below, which looks quite similar to CarID 2.
