...
2      |Clarity         |**Use color to show whether the partner is net exporter or net importer.**The bubbles and bar chart are blue when export trade amount of specific partner exceed import, otherwise they are in red color. In this case the audience could easily distinguish net exporters and net importers.
3      |Clarity         |**Add a bar chart to show the concrete net trade amount and the rank of it among trading partners of Singapore.**
