...
+ **Insight 1:** Looking at the total of the 10 years from 2011 to 2020, Singapore had the highest net export trade amount with Hong Kong, while holding the highest net import trade amount with Taiwan.
  ...
  + And if see the specific export and import trade amount of Singapore, we can find Hong Kong had the lowest ranking for import, as well as quite high ranking of export, and the trade amount was quite stable with in the ten years. On the other hand, Taiwan had relatively low ranking for export trade.
