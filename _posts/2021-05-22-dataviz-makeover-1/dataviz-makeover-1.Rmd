...
**NO.**|**Step**              |**Action**
-------|----------------------|--------------------------------------------
1      |Drag **Export** and **Import** fields from "Dimensions" area to "Measures" area in the left Tables pane| ![](img/step2.1.jpg){width=50%} <br> _Fig.7 Drag Export and Import to Measures_
...
4      |In Marks Pane, change the mark type from "Automatic" to "Shape" from the dropdown list, drag **Country/Region** to Colour button, **Measure Names** to Shape button and **Import** to Tooltip button| ![](img/step2.4.jpg){width=50%} <br> _Fig.10 Change the Marks_
